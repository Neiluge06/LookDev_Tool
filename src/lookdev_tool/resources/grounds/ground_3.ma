...
//Name: Ground_3.ma
//Last modified: Thu, Mar 30, 2023 11:53:54 AM
//Codeset: 1252
requires maya "2022";
...
fileInfo "osv" "Windows 10 Pro for Workstations v2009 (Build: 22621)";
fileInfo "UUID" "55E47C84-4C2D-CFA0-768E-C5A8C412A5DF";
createNode transform -s -n "persp";
	rename -uid "C216CED4-4A10-15A7-5554-BC968B2D7E22";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 49.206511717075131 36.904883787806355 49.206511717075145 ;
	setAttr ".r" -type "double3" -27.938352729602379 44.999999999999972 -5.172681101354183e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "44039206-4A9C-E9DE-1D6B-3B8C43C160A8";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 78.768851953781791;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "959A47CA-4055-5BA2-F768-9C8F803F444A";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 1000.1 0 ;
	setAttr ".r" -type "double3" -90 0 0 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "1B536BCA-4467-432A-1553-6C8FBFEA405E";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "front";
	rename -uid "542C12E7-4040-59ED-A054-1DB65B864F7F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "46FEBD7F-43A0-9191-A015-26B972F2010A";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode transform -s -n "side";
	rename -uid "4C329A23-47E7-6DF1-20B9-ACB643A5EA71";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1 0 0 ;
	setAttr ".r" -type "double3" 0 90 0 ;
createNode camera -s -n "sideShape" -p "side";
	rename -uid "883B9226-4E86-4E01-A603-0E8702A28753";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 30;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "F2F90197-43F0-B599-1BBF-29ACC86A4484";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode VRaySettingsNode -s -n "vraySettings";
	rename -uid "4A866C52-4B73-8D07-18FF-86898F6FD3C6";
	setAttr ".sver" 1;
	setAttr ".gi" yes;
	setAttr ".rfc" yes;
	setAttr ".pe" 2;
	...
	setAttr ".mSceneName" -type "string" "C:/Users/Etudiant/Documents/maya/2022/prefs/scripts/LookDev_Tool/Ground_3.ma";
...
createNode displayLayerManager -n "layerManager";
	rename -uid "4E7F18F2-406E-0BA6-D2F0-25B8AF0A3F34";
createNode displayLayer -n "defaultLayer";
	rename -uid "0AEF221E-428F-48C0-5687-22872426772D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "59FB3B56-4304-2FB9-9AB0-16B01437F8AE";
createNode renderLayer -n "defaultRenderLayer";
	rename -uid "DDC3E1AC-466B-17E7-29EB-05BB6B081817";
	setAttr ".g" yes;
createNode VRayMtl -n "Ground_3";
	rename -uid "E76C5BD0-456A-85AC-9CBE-1F89A4A2C217";
...
createNode shadingEngine -n "VRayMtl1SG";
	rename -uid "9E4650A4-421E-2159-B9B6-D5807C1447DA";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo1";
	rename -uid "F05AF7B5-4DDC-9FDB-D302-1C8F6883A019";
...
connectAttr "Ground_3.oc" "VRayMtl1SG.ss";
connectAttr "Ground_3_MshShape.iog" "VRayMtl1SG.dsm" -na;
connectAttr "VRayMtl1SG.msg" "materialInfo1.sg";
connectAttr "Ground_3.msg" "materialInfo1.m";
connectAttr "VRayMtl1SG.pa" ":renderPartition.st" -na;
connectAttr "Ground_3.msg" ":defaultShaderList1.s" -na;
